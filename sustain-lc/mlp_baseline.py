...
class Unified_PPO:
    ...
    def set_action_std(self, new_cdu_action_std):
        ...
        self.policy.set_cdu_action_std(new_cdu_action_std)
        self.policy_old.set_cdu_action_std(new_cdu_action_std)
    ...
    def select_action(self, states, return_imp_wts = False):
        ...
        self.buffer_dict['cdu_action'].actions.append(cdu_actions)
