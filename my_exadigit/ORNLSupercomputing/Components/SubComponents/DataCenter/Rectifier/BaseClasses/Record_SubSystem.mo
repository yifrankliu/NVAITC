within ORNLSupercomputing.Components.SubComponents.DataCenter.Rectifier.BaseClasses;
partial record Record_SubSystem
    replaceable package Medium = ORNLSupercomputing.Components.SubComponents.Media.Medium
