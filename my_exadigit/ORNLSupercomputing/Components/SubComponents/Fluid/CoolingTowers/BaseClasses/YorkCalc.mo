within ORNLSupercomputing.Components.SubComponents.Fluid.CoolingTowers.BaseClasses;
model YorkCalc
  "Cooling tower with variable speed using the York calculation for the approach 
  temperature modified to use user provided media"
  extends
