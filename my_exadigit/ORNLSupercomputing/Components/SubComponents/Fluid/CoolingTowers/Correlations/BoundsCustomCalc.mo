...
record BoundsCustomCalc
  "Coefficient data record for properties of York cooling tower model with a custom correlation"
  extends
    ORNLSupercomputing.Components.SubComponents.Fluid.CoolingTowers.Correlations.BaseClasses.Bounds(
