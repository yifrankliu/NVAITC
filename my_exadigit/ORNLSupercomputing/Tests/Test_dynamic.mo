...
model Test_dynamic
  ...
  extends Test_steady(simulator(redeclare Systems.CentralEnergyPlant.Models.v0
        centralEnergyPlant(redeclare
          ...
          hotWaterLoop), redeclare Systems.Datacenter.Models.v0 datacenter(
          redeclare Systems.Datacenter.Systems.CoolingBlock.Models.v0
          computeBlock(
          redeclare
