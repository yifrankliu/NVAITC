...
partial model PartialTest_FourPort_across_mT_pT_mT_pT
  ...
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T boundary_inlet_1(
    redeclare package Medium = Medium_1,
    m_flow=simulator[1].port_a1_start.m_flow,
  ...
  TRANSFORM.Fluid.Volumes.MixingVolume plenum_inlet_1(
    redeclare package Medium = Medium_1,
    p_start=simulator[1].port_a1_start.p,
    T_start=simulator[1].port_a1_start.T,
  ...
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T boundary_inlet_2(
    redeclare package Medium = Medium_2,
    m_flow=simulator[1].port_a2_start.m_flow,
  ...
  TRANSFORM.Fluid.Volumes.MixingVolume plenum_inlet_2(
    redeclare package Medium = Medium_2,
    p_start=simulator[1].port_a2_start.p,
    T_start=simulator[1].port_a2_start.T,
    redeclare replaceable model Geometry =
        TRANSFORM.Fluid.ClosureRelations.Geometry.Models.LumpedVolume.GenericVolume
        (V=0.1),
    nPorts_a=1,
