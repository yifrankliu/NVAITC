...
This file is intented to be used as a starting point to create a new language method.
For more details, see existing language method implementations.
"""

import pathlib

from ..language_method import LanguageMethod
# Import TEMPLATE-specific dependencies here, for example:
from . import create_model_example
from . import create_fmu_example
...
class TEMPLATEMethods(LanguageMethod):
    ...
    def create_architecture(self, template_folder: str = None, **kwargs):
        """
        Creates the language architecture by copying the template system structure.
    ...
    def create_model(self, structure_path: str = None, parent_class: str = 'ExaDigiT_AutoCSM.BaseClasses.Tests.PartialTest', **kwargs):
        """
        Creates the language model for the specified architecture.
