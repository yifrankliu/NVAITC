within GenericDatacenter.Systems.Datacenter.Systems.CoolingBlock.Models;
model v0
  ...
  replaceable Systems.CDU.Models.v0 cdu[structure.cdu.n_int] constrainedby
    ...
    "Select CDU model" annotation (Placement(transformation(extent={{-10,-16},{10,
            4}})), choicesAllMatching=true);
